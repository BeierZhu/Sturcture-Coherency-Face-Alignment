...
class MobileNetV2(nn.Module):
    def __init__(self,
        ...
        self.layer0 = self._make_layer(block, setting0)
        self.layer1 = self._make_layer(block, setting1)
        self.layer2 = self._make_layer(block, setting2)
        self.layer3 = self._make_layer(block, setting3)
        self.layer4 = self._make_layer(block, setting4)
