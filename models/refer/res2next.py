...
class Res2NeXt(nn.Module):
    def __init__(self, block, baseWidth, cardinality, layers, scale=4):
        """ Constructor
        Args:
        ...
        self.num_out_feats = [16*block.expansion, 32*block.expansion, 64*block.expansion, 128*block.expansion]
...
def Res2Next50(is_color, **kwargs):
    model = Res2NeXt(Bottle2neckX, layers = [3, 4, 6, 3], baseWidth = 4, cardinality=8, scale = 4)
    return model
