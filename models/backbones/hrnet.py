...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.num_out_feats = [final_inp_channels,final_inp_channels,final_inp_channels,final_inp_channels]
...
def get_face_alignment_net(**kwargs):
    with open('models/backbones/config_hrnet.yaml') as f:
        config = yaml.load(f)
...
def hrnetw32(**kwargs):
    with open('models/backbones/config_hrnetw32.yaml') as f:
        config = yaml.load(f)
    config = EasyDict(config)
